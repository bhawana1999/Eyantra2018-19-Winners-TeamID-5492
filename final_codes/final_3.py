...
class DroneFly():
    ...
    def __init__(self):
        ...
        # Blue
        self.Plant_location[2] = [4.8, -0.5, 22]
    ...
    def position_hold(self):
        ...
        while True:
            ...
            if self.counter == 9 and abs(self.drone_x - self.wp_x) < 0.4 and abs(self.drone_y- self.wp_y)< 0.4 and abs(self.drone_z - self.wp_z) < 0.8 and self.c==1:
                self.c += 1  
                print ("STOP")
                self.disarm()
