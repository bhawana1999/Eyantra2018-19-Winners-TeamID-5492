...
class DroneFly():
    ...
    def __init__(self):
        ...
        self.points = [[0, 5.78,23],[-5.3, 0.04, 21.6],[0,5.78,23],[-0.43, 5.67, 26.53],[-0.57 , 5.65, 27.44]]
        #self.points[2] = [0,5.78,23]
        #self.points[3] = [-0.43, 5.67, 26.53]
        #self.points[4] = [-0.57 , 5.65, 27.44]
        # self.points[0] = [0.45,5.66,16.0]
        #self.points[0] = [-5.4, 0.45, 14.8]
        # self.points[1] = [5.4, 0.45, 14.8]
        #self.points[1] = [0,0,25]
    ...
    def position_hold(self):
        ...
        while True:
            self.calc_pid()
            if self.counter==0 and abs(self.drone_z - self.wp_z)<self.threshZ:
            ...
            if (self.counter == 1) and abs(self.drone_x - self.wp_x) < 2 and abs(self.drone_y-self.wp_y)< 2 and abs(self.drone_z - self.wp_z) < 2:
                self.counter = self.counter + 1
                self.wp_x = self.points[self.counter][0]
                self.wp_y = self.points[self.counter][1]
                self.wp_z = self.points[self.counter][2]
            
            if (self.counter == 2) and abs(self.drone_x - self.wp_x) < 1 and abs(self.drone_y-self.wp_y)< 1 and abs(self.drone_z - self.wp_z) < 1:
                self.counter = self.counter + 1
                self.wp_x = self.points[self.counter][0]
                self.wp_y = self.points[self.counter][1]
                self.wp_z = self.points[self.counter][2]

            if (self.counter == 3) and abs(self.drone_x - self.wp_x) < 0.8 and abs(self.drone_y-self.wp_y)< 0.8 and abs(self.drone_z - self.wp_z) < 1:
                self.counter = self.counter + 1
                self.wp_x = self.points[self.counter][0]
                self.wp_y = self.points[self.counter][1]
                self.wp_z = self.points[self.counter][2]

            if (self.counter == 4) and abs(self.drone_x - self.wp_x) < 0.5 and abs(self.drone_y-self.wp_y)< 0.5 and abs(self.drone_z - self.wp_z) < 1 and self.c ==1:
                self.counter = self.counter + 1
                self.c += 1
                print ("STOP")
                self.disarm()
