...
class DroneFly():
    ...
    def __init__(self):
        ...
        self.points[6] = [0.02,5.78,21.31]
        self.points[7] = [-0.98, 6.04, 24.63]
        #self.points[7] = [0.04 , 5.9, 27.3]
        self.points[8] = [-0.17 , 5.75, 28]
        # Position to hold.
    ...
    def position_hold(self):
        ...
        while True:
            ...
            if self.counter == 6 and self.c==0:
            ...
            if self.counter == 6 and abs(self.drone_x - self.wp_x) < 2.5 and abs(self.drone_y-self.wp_y)< 2.5 and abs(self.drone_z - self.wp_z) < 2.5:
                self.counter = self.counter + 1
                self.wp_x = self.points[self.counter][0]
                self.wp_y = self.points[self.counter][1]
                self.wp_z = self.points[self.counter][2]
            ...
            if self.counter == 7 and abs(self.drone_x - (-0.98)) < 1 and abs(self.drone_y-6.04)< 1 and abs(self.drone_z - 24.5) < 1.2:
                self.counter = self.counter + 1
                self.wp_x = self.points[self.counter][0]
                self.wp_y = self.points[self.counter][1]
                self.wp_z = self.points[self.counter][2]
            ...
            if self.counter == 8 and abs(self.drone_x - (-0.19)) < 0.5 and abs(self.drone_y-5.6)< 0.5 and abs(self.drone_z - 28) < 1 and self.c==1:
                self.c += 1  
                print ("STOP")
                self.disarm()
