...
class DroneFly():
	...
	#Thresholds to Hold
        ...
        self.points[0]=[-5.6,-5.6,30]
        self.points[1]=[5.5,-5.6,30]
        self.points[2]=[5.5,5.5,30]
        self.points[3]=[-5.6,5.5,30]
    	self.points[4]=[0,0,30]
	...
	#Initial Position to hold.
        ...
        self.kp_throt = 32.0  # 21
        self.ki_throt = 3.0   # 2
        self.kd_throt = 26.0  # 3
